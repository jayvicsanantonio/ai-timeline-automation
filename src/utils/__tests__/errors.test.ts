...
describe('Error Classes', () => {
  ...
  describe('NewsSourceError', () => {
    ...
    it('should include source in context', () => {
      ...
      const error = new NewsSourceError('ArXiv', 'Parse error', context);
  ...
  describe('RateLimitError', () => {
    it('should create rate limit error with reset time', () => {
      ...
      expect(error.message).toContain('Rate limit exceeded for GitHub');
    });
  ...
  describe('ValidationError', () => {
    ...
    it('should include field value', () => {
      ...
      const error = new ValidationError('email', 'Invalid format', invalidValue);
  ...
  describe('GitHubError', () => {
    it('should create GitHub error', () => {
      const error = new GitHubError('create-branch', 'Branch already exists', 422);
    ...
    it('should determine if error is retryable', () => {
      const retryableError = new GitHubError('api-call', 'Server error', 500);
      const nonRetryableError = new GitHubError('api-call', 'Not found', 404);
      const rateLimitError = new GitHubError('api-call', 'Rate limited', 403);
  ...
  describe('AnalysisError', () => {
    it('should create analysis error', () => {
      const error = new AnalysisError('Invalid response format from AI model');
      
      expect(error).toBeInstanceOf(BaseError);
      expect(error.name).toBe('AnalysisError');
      expect(error.message).toBe('Invalid response format from AI model');
    });
  });

  describe('ConfigurationError', () => {
    it('should create configuration error', () => {
      const missingFields = ['OPENAI_API_KEY', 'GITHUB_TOKEN'];
      const error = new ConfigurationError('Missing required environment variables', missingFields);
  ...
  describe('AggregateError', () => {
    it('should create aggregate error with multiple errors', () => {
      ...
      const aggregateError = new AggregateError('Multiple sources failed', errors);
    ...
    it('should generate summary message', () => {
      ...
      const aggregateError = new AggregateError('Batch operation failed', errors);
    ...
    it('should filter errors by type', () => {
      ...
      const sourceErrors = aggregateError.getErrorsByType(NewsSourceError);
  ...
  describe('ErrorHandler', () => {
    ...
    it('should handle aggregate error', () => {
      ...
      const aggregateError = new AggregateError('Multiple failures', errors);
