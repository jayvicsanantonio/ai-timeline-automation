...
describe('News Source Types', () => {
  ...
  describe('NewsSource Abstract Class', () => {
    ...
    describe('Basic properties', () => {
      ...
      it('should report enabled status', () => {
        ...
        const disabledSource = new MockNewsSource({
          ...config,
          enabled: false
        });
  ...
  describe('Default Configurations', () => {
    ...
    it('should have appropriate reliability scores', () => {
      expect(DEFAULT_SOURCE_CONFIGS[NewsSourceName.OPENAI]?.reliability).toBe(
        SourceReliability.OFFICIAL
      );
      expect(DEFAULT_SOURCE_CONFIGS[NewsSourceName.ARXIV]?.reliability).toBe(
        SourceReliability.ACADEMIC
      );
      expect(DEFAULT_SOURCE_CONFIGS[NewsSourceName.THE_VERGE]?.reliability).toBe(
        SourceReliability.JOURNALISM
      );
      expect(DEFAULT_SOURCE_CONFIGS[NewsSourceName.HACKERNEWS]?.reliability).toBe(
